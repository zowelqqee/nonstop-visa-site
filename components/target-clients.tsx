...
const clients = [
  {
    ...
    description:
      "Переезд, ВНЖ и рабочая юридическая база для удаленной работы.",
  },
  {
    icon: Briefcase,
    title: "Предприниматели",
    description:
      "Запуск или перенос бизнеса в Армению с минимальной бюрократией.",
  },
  {
    icon: PenTool,
    title: "Фрилансеры",
    description:
      "Легальный статус, налоги и международные платежи без сложной рутины.",
  },
  {
    icon: TrendingUp,
    title: "Инвесторы",
    description:
      "Структурирование бизнеса и банковских процессов под инвестиционные задачи.",
  },
  {
    icon: Rocket,
    title: "Стартапы",
    description:
      "Быстрый юридический старт команды: компания, счет и бухгалтерия.",
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Работаем с частными клиентами и компаниями. Подбираем решение под конкретную цель.
          </p>
        </div>
