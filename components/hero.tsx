...
export function Hero() {
  ...
  return (
    <section
      id="top"
      ref={sectionRef}
      className="relative flex min-h-screen items-start overflow-hidden pt-12 sm:pt-16 lg:items-center lg:pt-28"
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-6 pt-2 pb-16 sm:pt-6 sm:pb-20 lg:grid-cols-2 lg:items-center lg:gap-14 lg:pt-0 lg:pb-24">
