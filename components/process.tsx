...
const steps = [
  {
    ...
    description:
      "Фиксируем цель, сроки и бюджет. Сразу определяем оптимальную услугу и формат работы.",
  },
  {
    icon: FileText,
    step: "02",
    ...
    description:
      "Собираем пакет без лишних бумаг: проверяем формулировки и соответствие требованиям.",
  },
  {
    icon: UserCheck,
    step: "03",
    ...
    description:
      "Подаем документы и ведем коммуникацию с госорганами и банками до решения.",
  },
  {
    icon: Award,
    step: "04",
    ...
    description:
      "Вы получаете готовый результат и понятные следующие шаги по продлению или развитию.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl lg:text-5xl">
            Процесс в 4 понятных шага
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Без сложных схем и бюрократии. На каждом этапе вы понимаете, что делаем и зачем.
          </p>
        </div>
